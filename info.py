...
USERNAME = environ.get('USERNAME', "https://t.me/Mradbot_Admin")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002213135179'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+UWWcCdAiXJswNmU1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002219201749').split()]
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002300338086'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1001369895425')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001816697837'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002228536126')
